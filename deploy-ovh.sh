...
show_deployment_instructions() {
    print_status "Instructions de déploiement OVH - Racha Digital:"
    echo ""
    echo -e "${YELLOW}Configuration OVH:${NC}"
    echo "  Host: 217.182.70.41"
    echo "  User: crm@rachadigital.com"
    echo "  Domain: crm.rachadigital.com"
    echo ""
    ...
    echo ""
    echo -e "${GREEN}Commandes FTP pour OVH:${NC}"
    echo "rsync -avz --delete dist/ crm@rachadigital.com@217.182.70.41:www/"
    echo "ou"
    echo "scp -r dist/* crm@rachadigital.com@217.182.70.41:www/"
    echo ""
    echo -e "${GREEN}Configuration FTP:${NC}"
    echo "  Host: 217.182.70.41"
    echo "  User: crm@rachadigital.com"
    echo "  Password: G13c8c_f3"
    echo "  Directory: www/"
    echo ""
    ...
    echo "- Le fichier .env.production (variables d'environnement)"
    echo ""
    echo -e "${GREEN}URL de votre application:${NC}"
    echo "https://crm.rachadigital.com"
    echo ""
    echo -e "${BLUE}Base de données:${NC}"
    echo "  Host: 217.182.70.41:3306"
    echo "  Database: admin_crm"
    echo "  User: kiwiland"
    echo "  MariaDB v10.3.39"
}
